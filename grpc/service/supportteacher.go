...
// func (c *SupportTeacherService) Update(ctx context.Context, req *user_service.UpdateSupportTeacherRequest) (*user_service.UpdateSupportTeacherResponse, error) {
...
// func (c *SupportTeacherService) Delete(ctx context.Context, req *user_service.SupportTeacherPrimaryKey) (*user_service.Empty, error) {
